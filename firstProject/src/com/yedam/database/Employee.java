...
public class Employee {
	...
	public Employee(int employeeId, String lastName, String email, String hireDate, String jobId) { //생성자
		super();
	...
	public int getEmployeeId() { //get method
		return employeeId;
	}

	public void setEmployeeId(int employeeId) { //set method
		this.employeeId = employeeId;
	}
